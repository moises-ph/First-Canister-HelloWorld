...
import { idlFactory } from './first-canister.did.js';
export { idlFactory } from './first-canister.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.FIRST-CANISTER_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./first-canister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the first-canister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./first-canister.did.js")._SERVICE>}
 */
export const first-canister = createActor(canisterId);
